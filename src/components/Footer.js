      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-section">
            <h3>आर्य पाठशाला</h3>
            <p>
              आर्यावर्त की प्राचीन शास्त्र परम्परा को जन-जन तक पहुँचाने हेतु
              समर्पित
            </p>
            {/* Social Media Links */}
          ...
          <div className="footer-section">
            ...
            <ul>
              ...
              <li>
                <a href="#cources">पाठ्यक्रम</a>
              </li>
              <li>
                <a href="#library">पुस्तकालय</a>
              </li>
              <li>
                <a href="#notices">सूचनाएँ</a>
              </li>
              <li>
                <a href="#contact">शंका समाधान एवं सम्पर्क</a>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-section">
            ...
            <ul>
              ...
              <li>
                <a href="#vedang">वेदांग</a>
              </li>
              <li>
                <a href="#">उपनिषद्</a>
              </li>
              <li>
                <a href="#">दर्शनशास्त्र</a>
              </li>
              <li>
                <a href="#">अन्य आर्षग्रन्थ</a>
              </li>
              <li>
                <a href="#">राष्ट्रीय पात्रता परीक्षा (संस्कृत 25)</a>
              </li>
              <li>
                <a href="#">राष्ट्रीय पात्रता परीक्षा (संस्कृत 73)</a>
              </li>
            </ul>
          </div>
